...
export default function HomePage() {
  ...
  return (
    <div id="main-content" className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-200" role="main" tabIndex={-1}>
      <div className="container mx-auto px-6 py-20">
        <header className="flex flex-col lg:flex-row items-center gap-8 mb-12" role="banner">
          <div className="flex-shrink-0">
            <div className="w-28 h-28 rounded-full bg-gradient-to-br from-cyan-500/10 to-teal-500/10 border border-cyan-500/20 flex items-center justify-center shadow-lg" aria-hidden="true">
              <MessageSquare className="w-12 h-12 text-cyan-400" aria-hidden="true" />
            </div>
          </div>
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="mt-6 flex items-center justify-center lg:justify-start gap-4">
              ...
              <a
                ...
                className="inline-flex items-center px-4 py-3 text-sm bg-slate-800/50 rounded-lg border border-slate-700 hover:bg-slate-800/70 transition focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:ring-offset-2 focus:ring-offset-slate-950"
              >
                Learn More
              </a>
            </div>
        ...
        {/* Features */}
        <section id="features" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12" aria-label="Features">
          <article className="glass-effect-light border border-cyan-500/10 p-6 rounded-xl hover:shadow-xl transition">
            <div className="w-12 h-12 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 border border-cyan-500/20 rounded-lg flex items-center justify-center mb-3" aria-hidden="true">
          ...
          <div className="p-6 rounded-xl bg-gradient-to-br from-slate-900/40 to-slate-900/30 border border-slate-800 shadow-md">
            ...
            <ul className="space-y-2" role="list">
              <li className="flex items-start gap-3" role="listitem">
                <span className="inline-flex items-center justify-center w-8 h-8 rounded bg-cyan-700/20 text-cyan-400" aria-hidden="true">✓</span>
            ...
            <div className="grid grid-cols-1 gap-3" role="list">
              {[
                ...
                <button 
                  ...
                  aria-label={`Ask: ${q}`}
                  role="listitem"
                  className="text-left p-3 bg-slate-900/40 rounded hover:bg-slate-900/60 transition focus:outline-none focus:ring-2 focus:ring-cyan-500/50"
                >
                  {q}
                </button>
              ))}
        ...
        {/* Footer */}
        <footer className="pt-12 border-t border-slate-800 text-center text-sm text-slate-400" role="contentinfo">
